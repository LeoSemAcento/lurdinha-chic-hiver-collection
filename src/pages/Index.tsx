...
const Index = () => {
  ...
  const heroBackgrounds = [
    ...
    "https://images.unsplash.com/photo-1608256246200-53e635b5b65f?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80"
  ];
        ...
        {heroBackgrounds.map((bg, index) => (
          <div
            ...
            style={{
              ...
              transform: `translateY(${scrollY * 0.5}px) scale(${index === currentSlide ? 1.05 : 1})`
            }}
          />
        ))}
